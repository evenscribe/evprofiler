...
pub fn symbolize_locations(
    ...
    for loc in locations {
        ...
        // if !index_map.contains_key(&decoded_location.build_id) {
        //     index_map.insert(decoded_location.build_id.clone(), IndexValue::default());
        // }
    ...
    for (build_id, mapping_addr_indx) in index_map.iter() {
        ...
        log::info!("Symbolized Request:{:#?}", sym_req)
    }
